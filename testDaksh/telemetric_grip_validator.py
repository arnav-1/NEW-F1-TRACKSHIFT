"""
TrackShift Non-Circular Telemetric Lateral Grip Validator (testDaksh/telemetric_grip_validator.py).
...
from testDaksh.numerical_schemas import GripValidationRecord

logger = logging.getLogger("testDaksh.grip_validator")
